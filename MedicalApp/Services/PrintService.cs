    ...
    public class PrintService : IPrintService
    {
        ...
        public void PrintReport(Patient patient, Visit visit)
        {
            ...
            if (printDialog.ShowDialog() == true)
            {
                ...
                printDialog.PrintDocument(idpSource.DocumentPaginator, $"CardioCenter Report - {patient.Name}");
            }
        }
        ...
        public void PrintPrescription(Patient patient, string prescriptionText)
        {
            ...
            // Set to A5 size if printer supports it
            ...
            if (printDialog.ShowDialog() == true)
            {
                ...
                // Print A5 Document
                IDocumentPaginatorSource idpSource = doc;
                printDialog.PrintDocument(idpSource.DocumentPaginator, $"CardioCenter Rx - {patient.Name}");
            }
        }
    }
}
